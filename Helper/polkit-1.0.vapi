/* polkit-1.0.vapi generated by vapigen, do not modify. */
...
namespace Polkit {
	...
	public class Authority : GLib.Object, GLib.AsyncInitable, GLib.Initable {
		...
		public async GLib.List<Polkit.ActionDescription> enumerate_temporary_authorizations (Polkit.Subject subject, GLib.Cancellable? cancellable) throws GLib.Error;
		public GLib.List<Polkit.ActionDescription> enumerate_temporary_authorizations_sync (Polkit.Subject subject, GLib.Cancellable? cancellable = null) throws GLib.Error;
	...
	public class Permission : GLib.Permission, GLib.AsyncInitable, GLib.Initable {
		...
		public async Permission (string action_id, Polkit.Subject? subject, GLib.Cancellable? cancellable);
		[CCode (has_construct_function = false, type = "GPermission*")]
		public Permission.finish (GLib.AsyncResult res) throws GLib.Error;
		public unowned string get_action_id ();
	...
	[CCode (cheader_filename = "polkit/polkit.h", cprefix = "POLKIT_AUTHORITY_FEATURES_")]
	[Flags]
	public enum AuthorityFeatures {
		NONE,
		TEMPORARY_AUTHORIZATION
	}
	[CCode (cheader_filename = "polkit/polkit.h", cprefix = "POLKIT_CHECK_AUTHORIZATION_FLAGS_")]
	[Flags]
	public enum CheckAuthorizationFlags {
		NONE,
		ALLOW_USER_INTERACTION
	}
	[CCode (cheader_filename = "polkit/polkit.h", cprefix = "POLKIT_IMPLICIT_AUTHORIZATION_")]
	public enum ImplicitAuthorization {
		...
		AUTHORIZED;
		public static bool from_string (string string, out Polkit.ImplicitAuthorization implicit_authorization);
	...
	[CCode (cheader_filename = "polkit/polkit.h", cname = "_POLKIT_INSIDE_POLKIT_H")]
	public const int _INSIDE_POLKIT_H;
