...
namespace Oobs {
	...
	public class List : GLib.Object {
		...
		public bool get_iter_first (ref Oobs.ListIter iter);
	...
	[Compact]
	public struct ListIter {
		public void* data;
		public uint stamp;
		public Oobs.ListIter copy ();
		public static bool next (Oobs.List list, ref Oobs.ListIter iter);
	}
	[CCode (cheader_filename = "oobs/oobs.h")]
	...
	public class Session : GLib.Object {
		...
		public Oobs.Result get_supported_platforms (out GLib.List<Oobs.Platform> platforms);
		public void process_requests ();
